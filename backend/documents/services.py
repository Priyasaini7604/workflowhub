...
def sync_onboarding_documents_submitted(employee):
    ...
    checklist, _ = OnboardingChecklist.objects.get_or_create(employee=employee)
...
def sync_onboarding_documents_verified(document):
    ...
    checklist, _ = OnboardingChecklist.objects.get_or_create(employee=document.employee)
...
def notify_document_verification(document, new_status):
    ...
    if new_status == 'rejected':
        notify(
            ...
            message=f'Your "{document.document_type}" document was rejected. Please re-upload a corrected copy.',
        ...
        notify(
            ...
            message=f'Your "{document.document_type}" document has been verified.',
            notification_type='general',
        )